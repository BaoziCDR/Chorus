---
name: openspec-aware
description: Legacy opt-in OpenSpec-mode authoring for Chorus PM workflows in Claude Code. Use only when the user explicitly asks for OpenSpec or an existing proposal carries OpenSpec provenance. The normal planning path is Chorus-first Spec Kit.
license: AGPL-3.0
metadata:
  author: chorus
  version: "0.8.2"
