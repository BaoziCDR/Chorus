...
OpenSpec is a legacy opt-in path; use it only when the user explicitly asks for OpenSpec or the current proposal already carries `OpenSpec change slug: <slug>` provenance.
